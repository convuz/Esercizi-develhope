...
//- Crea le variabili necessarie per specificare `marca`, `modello`, `anno di produzione` e `nome del proprietario` di un'auto e assegna loro un valore. 
// Dichiarale usando let e const dove ritieni opportuno.
